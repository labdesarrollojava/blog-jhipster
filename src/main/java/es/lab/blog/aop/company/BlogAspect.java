...
public class BlogAspect {
     ...
     */
    @Before(value = "execution(* es.lab.blog.repository.BlogRepository.save(..)) && args(blog, ..)")
    ...
    /**
     * Run method if Blog service findOne is hit.
     * Adds filtering to prevent display of information from another tenant
     */
    @Before(value = "execution(* es.lab.blog.service.BlogService.findOne(..)) && args(id, ..)")
